...
SUS_INLINE VEC2 SUSAPITM sMult2(VEC2 v, const sus_float s) {
	return (VEC2) { v.x* s, v.y* s };
}
// Dividing a 2D vector by a scalar
SUS_INLINE VEC2 SUSAPITM sDiv2(VEC2 v, const sus_float s) {
	return (VEC2) { v.x / s, v.y / s };
}
...
SUS_INLINE VEC3 SUSAPITM vScale3(VEC3 v, const sus_float s) {
...
SUS_INLINE VEC3 SUSAPITM sDiv3(VEC3 v, const sus_float s) {
	return (VEC3) { v.x / s, v.y / s, v.z / s };
}

// The scalar product of two 3D vectors
SUS_INLINE sus_float SUSAPITM vDot3(VEC3 v1, const VEC3 v2) {
	return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
}
// Calculating the length of a vector
SUS_INLINE sus_float SUSAPITM vLength3(const VEC3 v) {
	return (sus_float)sus_sqrt(vDot3(v, v));
}
...
SUS_INLINE sus_float SUSAPITM vDistance3(const VEC3 v1, const VEC3 v2) {
	return vLength3(vSub3(v1, v2));
}
// Getting the normal of the vector
SUS_INLINE VEC3 SUSAPITM vNormal3(const VEC3 v1, const VEC3 v2) {
