/*
    ...
    OpenGL loader generated by glad, modified by susfwk 0.1.36 on 12.27 23:38 2025.
    Specification: gl
    APIs: gl=3.3
    Commandline:
...
# endif
    ...
    typedef void GLvoid;
    typedef sus_i8_t GLbyte;
    typedef sus_u8_t GLubyte;
    typedef sus_i16_t GLshort;
    typedef sus_u16_t GLushort;
    typedef sus_int_t GLint;
    typedef sus_uint_t GLuint;
    typedef sus_i32_t GLclampx;
    typedef sus_int_t GLsizei;
    typedef sus_float_t GLfloat;
    typedef sus_float_t GLclampf;
    typedef sus_double_t GLdouble;
    typedef sus_double_t GLclampd;
...
#endif
    typedef sus_u16_t GLhalf;
    typedef sus_u16_t GLhalfARB;
    typedef sus_i32_t GLfixed;
    typedef sus_intptr_t GLintptr;
    typedef sus_intptr_t GLintptrARB;
    typedef sus_size_t GLsizeiptr;
    typedef sus_size_t GLsizeiptrARB;
    typedef sus_i64_t GLint64;
    typedef sus_i64_t GLint64EXT;
    typedef sus_u64_t GLuint64;
    typedef sus_u64_t GLuint64EXT;
